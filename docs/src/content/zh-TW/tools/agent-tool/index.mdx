...
- [代理生命週期](./agent-lifecycle) — 完整生命週期：prompt 建構、工具過濾、執行上下文
- [隔離與 Worktree](./isolation-and-worktrees) — Git worktree 建立、清理和檔案系統隔離機制
- [背景執行](./background-execution) — 非同步代理執行、通知系統、平行協調和恢復機制
