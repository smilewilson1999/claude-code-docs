...
- [Permission Evaluation](./permission-evaluation) — The full permission check pipeline: mode resolution, rule matching, and caching
- [Permission Hooks](./permission-hooks) — Shell hook execution, parameter modification, and custom policies
- [Safety Rules](./safety-rules) — Built-in safety rules, destructive operation detection, and secret file protection
