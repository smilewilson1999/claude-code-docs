...
- [Store Architecture](./store-architecture) — AppStateStore internals, slice organization, and mutation patterns
- [React Integration](./react-integration) — Context providers, useAppState hook, and re-render optimization
- [Change Detection](./change-detection) — onChangeAppState system, side effect triggers, and persistence
- [Selectors](./selectors) — Memoized selectors, derived state computation, and performance patterns
