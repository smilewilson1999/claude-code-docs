...
- [客户端架构](./client-architecture) — MCP 客户端内部、传输抽象（stdio、SSE、进程内）
- [服务器生命周期](./server-lifecycle) — 发现、启动、握手、能力交换和清理
- [工具注册](./tool-registration) — MCP 服务器工具如何成为 Claude Code 工具、Schema 映射和权限集成
